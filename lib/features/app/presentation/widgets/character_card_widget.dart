...
class CharacterCard extends StatelessWidget {
  final String url;
   ...
   CharacterCard({Key key, this.url = "https://cdn.pixabay.com/photo/2017/06/28/04/29/adult-2449725_960_720.jpg"}) : super(key: key);
  @override
    ...
    return Container(
      ...
      child: Card(
        ...
        Padding(
          ...
          child: Text("Baby Legs", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white),),
        ),
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Row(children: [
            Icon(MdiIcons.moonFull, size: 12, color: Colors.green,),
             Padding(
               padding: const EdgeInsets.only(left: 6),
               child: Text("Alive - Human", style: TextStyle(color: Colors.white),),
             )
          ],),
        ),
        Padding(
